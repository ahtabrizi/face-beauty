...
left_img = io.imread('post/Case#2_3_L_post_Pa_Ro.png')
right_img = io.imread('post/Case#2_2_R_post_Pa_Ro.png')
front_img = io.imread('post/Case#2_1_F_post_Pa_Ro_Sc_Tr_Ep.png')
